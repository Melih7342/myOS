SECURITY_RESOURCES = {
    ...
    "fedora": "https://docs.fedoraproject.org/en-US/fedora/latest/security-guide/",
    ...
    "rhel": "https://docs.redhat.com/de/documentation/red_hat_enterprise_linux/9/html-single/security_hardening/index",
