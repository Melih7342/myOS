...
const questions = [
  ...
  },
  {
    ...
    options: ["Rolling Release", "Stable Release", "A mix of both"],
  },
  {
    id: 10,
    genre: "design",
  ...
  },
  {
    ...
    genre: "philosophy",
    question:
      "Are you okay with using proprietary software (e.g. Nvidia drivers)?",
    options: ["Proprietary is fine", "Open Source only", "Only if necessary"],
  },
  {
    id: 12,
    genre: "system_base",
